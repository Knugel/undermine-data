...
import { Fragment, MouseEvent as ReactMouseEvent, useCallback, useEffect, useState } from 'react';
...
function BehaviorTreeGraph(props: Props) {
    ...
    const doLayout = useCallback((elements: Elements, direction = 'TB') => {
    ...
    }, [props.Instance.TaskJSON, doLayout]);
